...
func (s *BBKScraper) GetLiveTiming() (*models.ResultScrape, error) {
...
func (s *BBKScraper) GetPracticeRaceResult(practice, round int) (*models.ResultScrape, error) {
...
func (s *BBKScraper) GetQualiRaceResult(heat, round int) (*models.ResultScrape, error) {
	if heat < 1 || round < 1 {
...
func (s *BBKScraper) GetFinalRaceResult(final, leg int) (*models.ResultScrape, error) {
	if final < 1 || leg < 1 {
